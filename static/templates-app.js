angular.module('templates-app', ['about/about.tpl.html', 'athlete/athlete.tpl.html', 'home/home.tpl.html']);
...
angular.module("athlete/athlete.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("athlete/athlete.tpl.html",
    "<div class=\"container\" ng-controller=\"AthleteCtrl as athlete\">\n" +
    "    <img class=\"imgEmptySection\" src=\"./assets/img/tkd_athletes.png\">\n" +
    "    <input ng-model=\"nombre\"/>\n" +
    "    <button ng-click=\"getAthlete()\">Click me!</button>\n" +
    "    <button ng-click=\"useHttp()\">Display GET Result!</button>\n" +
